...
const ArtPiecePage = (props: ArtPiecePageProps) => {
  return (
    <>
      <div className="fixed z-50 left-0 right-0 top-0 w-full h-full flex mx-auto items-center max-w-[68rem]">
        <ArtPrevNextButton
          type="PREV"
          href={{
          ...
          <div className="w-full grid gap-4 grid-cols-4 items-center">
            ...
            <div className="flex flex-row w-full col-span-4 sm:col-span-2 sm:col-start-3">
              <Link href={props.item.shopItemUrl} passHref>
                <motion.a
                  className="font-bold rounded-lg p-4 mx-8 sm:mx-0 w-full self-end bg-pink text-white text-lg md:text-xl select-none cursor-pointer block relative z-50"
